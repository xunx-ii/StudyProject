...
class FTaskBuilderConnectionDrawingPolicy : public FConnectionDrawingPolicy
{
public:
	//
	FTaskBuilderConnectionDrawingPolicy(int32 InBackLayerID, int32 InFrontLayerID, float ZoomFactor, const FSlateRect& InClippingRect, FSlateWindowElementList& InDrawElements, UEdGraph* InGraphObj);
